...
## Showstopper.
At this time, the [authors](https://github.com/WongKinYiu/yolov9) have not yet released any small models. Only the compact and full are available.<br>
Therefore, YoloV9 will be very slow on a Raspberry Pi. See also [issue #3](https://github.com/WongKinYiu/yolov9/issues/3)
...
$ mkdir *MyDir* <br/>
$ cd *MyDir* <br/>
$ wget https://github.com/Qengineering/YoloV9-ncnn-Raspberry-Pi-4/archive/refs/heads/main.zip <br/>
...
### Thanks.
A more than special thanks to [***twlelev***](https://github.com/twlelev/Yolov9-Ncnn), who adapted the YoloV9 model to the ncnn framework.<br><br>
![output image]( https://qengineering.eu/github/test_busV9.webp )
